...
def rate_all(user, restaurants, feature_fns):
    ...
    predicted_ratings = [predictor(restaurant) for restaurant in restaurants]
    dict_all = {x:y for x,y in zip(names, predicted_ratings)}

    reviewed_names = [restaurant_name(restaurant) for restaurant in reviewed]
    user_ratings = [user_rating(user, restaurant) for restaurant in reviewed_names]
    dict_user = {x:y for x,y in zip(reviewed_names, user_ratings)}
